...
namespace Asil_Insaat.Service.Describers
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        {
            return new IdentityError { Code = "DublicateEmail", Description = $"Bu e-mail '{email}' adresine ait bir hesap zaten var." };
        }
        public override IdentityError DuplicateUserName(string userName)
        {
            return new IdentityError { Code = "DuplicateUserName", Description = $"Bu e-mail '{userName}' adresine ait bir hesap zaten var." };
        }
        ...
        {
            return new IdentityError { Code = "InvalidEmail", Description = $"Belirtilen e-mail {email} adresi geçersizdir." };
        }
        ...
        {
            return new IdentityError { Code = "InvalidUserName", Description = $"Belirtilen e-mail {userName} adresi geçersizdir." };
        }
